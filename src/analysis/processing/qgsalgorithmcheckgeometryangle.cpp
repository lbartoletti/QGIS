...
auto QgsGeometryCheckAngleAlgorithm::flags() const -> QgsProcessingAlgorithm::Flags
{
...
static auto resolutionMethods() -> QStringList
{
  static const QStringList methods = QStringList()
                                     << QObject::tr( "Delete node with small angle" )
...
void QgsGeometryCheckAngleAlgorithm::initAlgorithm( const QVariantMap &configuration )
{
  ...
  addParameter( new QgsProcessingParameterNumber( QStringLiteral( "MIN_ANGLE" ), QObject::tr( "min angle" ), QgsProcessingParameterNumber::Double, 0, false, 0.0, 180.0 ) );
...
//  addParameter( new QgsProcessingParameterEnum( QStringLiteral( "RESOLUTIONMETHOD"), QObject::tr( "Resolution method"), QgsGeometryAngleCheck::resolutionMethods() ) );
...
bool QgsGeometryCheckAngleAlgorithm::supportInPlaceEdit( const QgsMapLayer *layer ) const
{
