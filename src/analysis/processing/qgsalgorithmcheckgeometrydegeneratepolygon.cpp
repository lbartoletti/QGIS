...
auto QgsGeometryCheckDegeneratePolygonAlgorithm::name() const -> QString
{
  return QStringLiteral( "checkgeometrydegeneratepolygon" );
}

auto QgsGeometryCheckDegeneratePolygonAlgorithm::displayName() const -> QString
{
  return QObject::tr( "Check Geometry (Degenerate polygon)" );
}

auto QgsGeometryCheckDegeneratePolygonAlgorithm::tags() const -> QStringList
{
  return QObject::tr( "check,geometry,degeneratepolygon" ).split( ',' );
}

auto QgsGeometryCheckDegeneratePolygonAlgorithm::group() const -> QString
{
  return QObject::tr( "Check geometry" );
}

auto QgsGeometryCheckDegeneratePolygonAlgorithm::groupId() const -> QString
{
  return QStringLiteral( "checkgeometry" );
}

auto QgsGeometryCheckDegeneratePolygonAlgorithm::shortHelpString() const -> QString
{
  return QObject::tr( "This algorithm check the degeneratepolygon of geometry." );
}

auto QgsGeometryCheckDegeneratePolygonAlgorithm::flags() const -> QgsProcessingAlgorithm::Flags
{
  return QgsProcessingAlgorithm::flags() | QgsProcessingAlgorithm::FlagNoThreading;
}

auto QgsGeometryCheckDegeneratePolygonAlgorithm::createInstance() const -> QgsGeometryCheckDegeneratePolygonAlgorithm *
{
...
auto QgsGeometryCheckDegeneratePolygonAlgorithm::prepareAlgorithm( const QVariantMap &parameters, QgsProcessingContext &context, QgsProcessingFeedback * ) -> bool
{
  mTolerance = parameterAsInt( parameters, QStringLiteral( "TOLERANCE" ), context );
  return true;
}

auto QgsGeometryCheckDegeneratePolygonAlgorithm::createFeaturePool( QgsVectorLayer *layer, bool selectedOnly ) const -> QgsFeaturePool *
{
...
auto QgsGeometryCheckDegeneratePolygonAlgorithm::processAlgorithm( const QVariantMap &parameters, QgsProcessingContext &context, QgsProcessingFeedback *feedback ) -> QVariantMap
{
  QString dest_output;
  QString dest_errors;
  ...
  const QgsGeometryDegeneratePolygonCheck check( checkContext.get(), QVariantMap() );
