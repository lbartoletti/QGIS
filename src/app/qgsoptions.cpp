...

{
  ...
  mDefaultSnapModeComboBox->addItem( tr( "No Snapping" ), static_cast<int>( QgsSnappingConfig::SnappingTypes::NoSnapFlag ) );
  mDefaultSnapModeComboBox->addItem( tr( "Vertex" ), static_cast<int>( QgsSnappingConfig::SnappingTypes::VertexFlag ) );
  mDefaultSnapModeComboBox->addItem( tr( "Segment" ), static_cast<int>( QgsSnappingConfig::SnappingTypes::SegmentFlag ) );
  mDefaultSnapModeComboBox->addItem( tr( "Centroid" ), static_cast<int>( QgsSnappingConfig::SnappingTypes::CentroidFlag ) );
  mDefaultSnapModeComboBox->addItem( tr( "Middle of Segments" ), static_cast<int>( QgsSnappingConfig::SnappingTypes::MiddleOfSegmentFlag ) );
  mDefaultSnapModeComboBox->addItem( tr( "Area" ), static_cast<int>( QgsSnappingConfig::SnappingTypes::AreaFlag ) );
  QgsSnappingConfig::SnappingTypeFlag defaultSnapMode = mSettings->flagValue<QgsSnappingConfig::SnappingTypeFlag>( QStringLiteral( "/qgis/digitizing/default_snap_type" ),  QgsSnappingConfig::SnappingTypes::VertexFlag );
