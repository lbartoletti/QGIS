...
Q_GLOBAL_STATIC_WITH_ARGS( WkbEntries, sWkbEntries, (
{
  ...
  //polyhedralsurface
  { Qgis::WkbType::PolyhedralSurface, WkbEntry( QLatin1String( "PolyhedralSurface" ), true, Qgis::WkbType::PolyhedralSurface, Qgis::WkbType::Polygon, Qgis::WkbType::PolyhedralSurface, Qgis::GeometryType::Polygon, false, false ) },
  { Qgis::WkbType::PolyhedralSurfaceZ, WkbEntry( QLatin1String( "PolyhedralSurfaceZ" ), true, Qgis::WkbType::PolyhedralSurfaceZ, Qgis::WkbType::PolygonZ, Qgis::WkbType::PolyhedralSurface, Qgis::GeometryType::Polygon, true, false ) },
  { Qgis::WkbType::PolyhedralSurfaceM, WkbEntry( QLatin1String( "PolyhedralSurfaceM" ), true, Qgis::WkbType::PolyhedralSurfaceM, Qgis::WkbType::PolygonM, Qgis::WkbType::PolyhedralSurface, Qgis::GeometryType::Polygon, false, true ) },
  { Qgis::WkbType::PolyhedralSurfaceZM, WkbEntry( QLatin1String( "PolyhedralSurfaceZM" ), true, Qgis::WkbType::PolyhedralSurfaceZM, Qgis::WkbType::PolygonZM, Qgis::WkbType::PolyhedralSurface, Qgis::GeometryType::Polygon, true, true ) },
  //TIN
  ...
  { Qgis::WkbType::TINZ, WkbEntry( QLatin1String( "TINZ" ), true, Qgis::WkbType::TINZ, Qgis::WkbType::Triangle, Qgis::WkbType::TINZ, Qgis::GeometryType::Polygon, true, false ) },
  { Qgis::WkbType::TINM, WkbEntry( QLatin1String( "TINM" ), true, Qgis::WkbType::TINM, Qgis::WkbType::Triangle, Qgis::WkbType::TINM, Qgis::GeometryType::Polygon, false, true ) },
  { Qgis::WkbType::TINZM, WkbEntry( QLatin1String( "TINZM" ), true, Qgis::WkbType::TINZM, Qgis::WkbType::Triangle, Qgis::WkbType::TINZM, Qgis::GeometryType::Polygon, true, true ) },
  //multipoint
