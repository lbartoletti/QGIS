...
class CORE_EXPORT QgsPolyhedralSurface: public QgsSurface
{
  public:
    ...
    /**
     * Creates a polyhedral surface from a multiPolygon, transferring ownership to the polyhedral surface.
     */
    QgsPolyhedralSurface( QgsMultiPolygon *multiPolygon SIP_TRANSFER );
