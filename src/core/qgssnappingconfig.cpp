...
QgsSnappingConfig::SnappingType QgsSnappingConfig::IndividualLayerSettings::type() const
{
  ...
  if ( ( mType & SnappingTypes::SegmentFlag ) && ( mType & SnappingTypes::VertexFlag ) )
    return QgsSnappingConfig::SnappingType::VertexAndSegment;
  else if ( mType & SnappingTypes::SegmentFlag )
...
void QgsSnappingConfig::IndividualLayerSettings::setType( QgsSnappingConfig::SnappingType type )
{
  ...
  {
    case 1:
      mType = SnappingTypes::VertexFlag;
      break;
    case 2:
      mType = SnappingTypes::VertexFlag | SnappingTypes::SegmentFlag;
      break;
    case 3:
      mType = SnappingTypes::SegmentFlag;
      break;
    default:
      mType = SnappingTypes::NoSnapFlag;
      break;
  }
}
...
void QgsSnappingConfig::reset()
{
  ...
  QgsSnappingConfig::SnappingTypeFlag type = QgsSettings().flagValue<QgsSnappingConfig::SnappingTypeFlag>( QStringLiteral( "/qgis/digitizing/default_snap_type" ),  QgsSnappingConfig::SnappingTypes::VertexFlag );
...
void QgsSnappingConfig::setType( QgsSnappingConfig::SnappingType type )
{
  switch ( type )
  {
    ...
    case SnappingType::VertexAndSegment:
      mType = static_cast<QgsSnappingConfig::SnappingTypeFlag>( QgsSnappingConfig::SnappingTypes::VertexFlag | QgsSnappingConfig::SnappingTypes::SegmentFlag );
      break;
...
bool QgsSnappingConfig::addLayers( const QList<QgsMapLayer *> &layers )
{
  ...
  QgsSnappingConfig::SnappingTypeFlag type = QgsSettings().enumValue( QStringLiteral( "/qgis/digitizing/default_snap_type" ), SnappingTypes::VertexFlag );
  double tolerance = QgsSettings().value( QStringLiteral( "/qgis/digitizing/default_snapping_tolerance" ), Qgis::DEFAULT_SNAP_TOLERANCE ).toDouble();
  QgsTolerance::UnitType units = QgsSettings().enumValue( QStringLiteral( "/qgis/digitizing/default_snapping_tolerance_unit" ), Qgis::DEFAULT_SNAP_UNITS );
...
void QgsSnappingConfig::readLegacySettings()
{
  ...
  for ( ; layerIt != layerIdList.constEnd(); ++layerIt, ++tolIt, ++tolUnitIt, ++snapIt, ++enabledIt )
  {
    ...
    QgsSnappingConfig::SnappingTypeFlag t( *snapIt == QLatin1String( "to_vertex" ) ? SnappingTypes::VertexFlag :
                                           ( *snapIt == QLatin1String( "to_segment" ) ? SnappingTypes::SegmentFlag :
                                               static_cast<QgsSnappingConfig::SnappingTypeFlag>( QgsSnappingConfig::SnappingTypes::VertexFlag | QgsSnappingConfig::SnappingTypes::SegmentFlag )
                                           )
                                         );
