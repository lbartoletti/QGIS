...
class GUI_EXPORT QgsBezierData
{
  public:
     ...
     *
     * This helper method updates the positions of handles adjacent to an anchor
     * in the provided \a controlPoints list to ensure symmetric movement.
     *
     * \param controlPoints The list of control points to update (in Poly-Bézier layout).
     ...
     * \param handleFollow The handle that will be moved to \a mousePosition (optional).
     * \param handleOpposite The handle that will be moved to the symmetric opposite position (optional).
     * \since QGIS 4.0
     */
