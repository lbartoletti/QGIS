...
// void TestQgsTriangulatedSurface::testToPolygon()
// {
//   QgsTriangulatedSurface surface = QgsTriangulatedSurface();
//   QCOMPARE( *surface.toPolygon(), QgsTriangle() );

//   std::unique_ptr< QgsTriangle > surface( surface.surfaceToPolygon() );
//   QVERIFY( surface->isEmpty() );

//   QgsLineString *patch = new QgsLineString();
//   patch->setPoints( QgsPointSequence() << QgsPoint( 0, 0 )
//                   << QgsPoint( 1, 10 ) << QgsPoint( 0, 18 )
//                   << QgsPoint( -1, 4 ) << QgsPoint( 0, 0 ) );
//   surface.setExteriorRing( patch );

//   surface.reset( surface.toPolygon() );
...
//   QgsRectangle r1 = patch->boundingBox();
...
//   QgsLineString *patch = new QgsLineString();
//   patch->setPoints( QgsPointSequence() << QgsPoint( Qgis::WkbType::PointZM, 1, 1, 1, 2 )
...
//   // too many vertices to actually check the result, let's just make sure the bounding boxes are similar
//   r1 = patch->boundingBox();
//   r2 = surface->patch( 0 )->boundingBox();
...
//   std::unique_ptr< QgsTriangulatedSurface > curveType( surface.toCurveType() );
//   QCOMPARE( *curveType, surface );
// }

// void TestQgsTriangulatedSurface::testSurfaceToPolygon()
// {
//   QgsTriangulatedSurface surface;
...
//   QgsLineString *patch = new QgsLineString();
//   patch->setPoints( QgsPointSequence() << QgsPoint( 0, 0 ) << QgsPoint( 1, 3 )
//                   << QgsPoint( 2, 4 ) << QgsPoint( -1, 5 ) << QgsPoint( 0, 6 ) );
//   surface.setExteriorRing( patch );

//   surface.reset( surface.surfaceToPolygon() );
//   QCOMPARE( surface->wkbType(), Qgis::WkbType::Polygon );
