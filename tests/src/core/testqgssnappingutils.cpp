...
class TestQgsSnappingUtils : public QObject
{
  ...
  private slots:
    ...
    void testSnapModeCurrent()
    {
      ...
      snappingConfig.setTypeFlag( QgsSnappingConfig::SnappingTypes::VertexFlag );
      u.setConfig( snappingConfig );
    ...
    void testSnapModeAdvanced()
    {
      ...
      snappingConfig.setIndividualLayerSettings( mVL, QgsSnappingConfig::IndividualLayerSettings( true, QgsSnappingConfig::SnappingTypes::VertexFlag, 10, QgsTolerance::Pixels ) );
      u.setConfig( snappingConfig );
    ...
    void testSnapOnIntersection()
    {
      ...
      snappingConfig.setEnabled( true );
      snappingConfig.setMode( QgsSnappingConfig::AdvancedConfiguration );
      QgsSnappingConfig::IndividualLayerSettings layerSettings( true, QgsSnappingConfig::SnappingTypes::VertexFlag, 0.1, QgsTolerance::ProjectUnits );
    ...
    void testSnapOnIntersectionCurveZ()
    {
      ...
      snappingConfig.setEnabled( true );
      snappingConfig.setMode( QgsSnappingConfig::AdvancedConfiguration );
      QgsSnappingConfig::IndividualLayerSettings layerSettings( true, QgsSnappingConfig::SnappingTypes::VertexFlag, 0.2, QgsTolerance::ProjectUnits );
      snappingConfig.setIntersectionSnapping( true );
    ...
    void testSnapOnCentroidAndMiddleSegment()
    {
      ...
      snappingConfig.setEnabled( true );
      snappingConfig.setMode( QgsSnappingConfig::AdvancedConfiguration );
      QgsSnappingConfig::IndividualLayerSettings layerSettings( true, static_cast<QgsSnappingConfig::SnappingTypeFlag>( QgsSnappingConfig::SnappingTypes::MiddleOfSegmentFlag | QgsSnappingConfig::SnappingTypes::CentroidFlag ), 0.2, QgsTolerance::ProjectUnits );
